//Editor script for Quiz game by Android | Helper (RU). || Скрипт для редактора игры викторины от Android | Helper (RU).
using UnityEngine;
using UnityEditor;
...
public class QuizEditor : Editor
{
    ...
    public override void OnInspectorGUI()
    {
        ...
        if (SceneManager.GetActiveScene().isDirty) EditorGUILayout.HelpBox("Не забудьте сохранить проект!", MessageType.Warning);
        EditorGUILayout.Space();
